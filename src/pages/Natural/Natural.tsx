...
export default function Natural() {
  const naturalList = listOrchids.filter((orchid) => orchid.isSpecial === true)
  return (
    <div className='w-full space-y-4'>
      ...
      <section className='space-y-10 py-16'>
        <h2 className='text-center text-2xl font-bold'>List natural orchids</h2>
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-10'>
          {naturalList.map((orchid) => (
